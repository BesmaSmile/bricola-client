...
import NotificationHandler from 'src/tools/notificationHandler';
...
class NotificationService {
  ...
  createOrUpdateChannel() {
    ...
    PushNotification.createChannel(
      {
        channelId: 'bricola-dz-channel', // (required)
  ...
  localNotif({
    ...
    PushNotification.localNotification({
      ...
      largeIconUrl, // (optional) default: "ic_launcher"
      largeIcon,
